...
class StripeManager
{
     ...
     */
    private function getChargeFromPaymentIntent(Stripe\PaymentIntent $intent): ?Stripe\Charge
    {
    ...
    private function createTransfersForHub(PaymentInterface $payment, Stripe\Charge $charge)
    {
        $order = $payment->getOrder();
